...
from models.tf_dynamics_models import utils
...
class FakeEnv:
    def __init__(self, model, config,
        ...
        self.model_weight = np.array([1./5, 1./5, 1./5, 1./5, 1./5])
    ...
    def step(self, obs, act, deterministic=False):
        ...
        terminals = self.config.termination_fn(
            utils.unnormalize(obs, self.obs_mean, self.obs_std),
            act,
            utils.unnormalize(next_obs, self.obs_mean, self.obs_std)
        )
